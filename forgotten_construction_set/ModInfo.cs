...
namespace forgotten_construction_set
{
	public class ModInfo : Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.gbImage.Text = "Preview image";
			...
			this.toolTipInfo.SetToolTip(this.btnRemoveImage, "Remove preview image");
			...
			this.toolTipInfo.SetToolTip(this.btnSetImage, "Load preview image");
			...
			this.toolTipInfo.SetToolTip(this.btnClearChangeNotes, "Clear change notes content");
			...
			this.toolTipInfo.SetToolTip(this.btnRefreshFromSteam, "Update mod's info from Steam");
			...
			this.linkSteamWorkshopAgreement.Text = "By submitting this item, you agree to the workshop terms of service";
			...
			this.toolTipInfo.SetToolTip(this.btnOpenFolder, "Open the mod's folder");
